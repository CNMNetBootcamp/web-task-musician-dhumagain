...
namespace Musicians.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InstrumentID,MusicalFlat,InstrumentName")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InstrumentID,MusicalFlat,InstrumentName")] Instrument instrument)
        {
