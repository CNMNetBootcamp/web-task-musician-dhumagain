...
namespace Musicians.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SongID,Title,Author")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SongID,Title,Author")] Song song)
        {
            if (id != song.SongID)
            {
                return NotFound();
